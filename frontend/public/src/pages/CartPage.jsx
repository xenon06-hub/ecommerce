...
const styles = {
  ...
  item:        { display:'flex', alignItems:'center', gap:16, background:'#fff',
                 padding:16, borderRadius:12, boxShadow:'0 2px 8px rgba(0,0,0,0.06)' },
  ...
  qtyBtn:      { width:30, height:30, borderRadius:6, border:'1.5px solid #ddd',
  ...
  checkoutBtn: { width:'100%', padding:'14px 0', background:'#e94560', color:'#fff',
                 border:'none', borderRadius:10, fontWeight:700, fontSize:16, cursor:'pointer', marginTop:16 },
};